...
- start a [Spacelift agent](https://docs.spacelift.io/concepts/worker-pools#launch-worker-pool) in your own infrastructure (yes, it will run on your laptop, too);
